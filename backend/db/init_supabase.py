...
# Load the .env that sits in backend/
...
# IMPORTANT: use the SERVICE ROLE key on the server (never in the browser)
SUPABASE_KEY = _clean(os.getenv("SUPABASE_SERVICE_ROLE_KEY"))
